...
<h4><a href="menuAlbums.php#" id="shashin_examples" class="shashin_admin_heading"><img src="<?php echo $this->functionsFacade->getPluginsUrl('images/plus.gif', __FILE__); ?>" id="shashin_examples_button" />Examples</a></h4>
...
<?php echo ToppaHtmlFormField::quickBuild('rssUrl', $this->albumRef->dataUrl); ?><br />
<?php _e("Include album's photos in random photo displays?", 'shashin'); ?>
<?php echo ToppaHtmlFormField::quickBuild('includeInRandom', $this->albumRef->includeInRandom, "Y"); ?></p>
