...
require_once(dirname(__FILE__) . '/../ShashinShortcodeValidator.php');

class UnitShashinShortcodeValidator extends UnitTestCase {
    ...
    public function testValidateType() {
        foreach ($this->validTestCases as $case) {
            $validator = new ShashinShortcodeValidator($case);
            $this->assertTrue($validator->validateType());
        }

        try {
            $validator = new ShashinShortcodeValidator($this->invalidTestCases['invalid']);
