...
require_once(dirname(__FILE__) . '/../ShashinSynchronizer.php');
require_once(dirname(__FILE__) . '/../ShashinSynchronizerPicasa.php');

Mock::generate('FakeWpHttp');

class UnitShashinSynchronizerPicasa extends UnitTestCase {
    ...
    public function setUp() {
        ...
        $this->synchronizer = new ShashinSynchronizerPicasa($this->httpRequester);
    }
